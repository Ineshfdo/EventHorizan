        ...
        <?php foreach($events as $event): ?>
          <tr class="border-b hover:bg-gray-50">
            ...
            <td class="p-3 space-x-2">
              <a href="edit_event.php?id=<?= $event['id'] ?>" class="text-blue-600 hover:underline">Edit</a>
              <a href="?delete_event=<?= $event['id'] ?>" class="text-red-600 hover:underline" onclick="return confirm('Are you sure you want to delete this event?')">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>

    ...
    <form action="" method="POST" enctype="multipart/form-data" class="space-y-4">
      ...
      <div>
        ...
        <?php if($club['club_main_image']): ?>
          <img src="../uploads/<?= $club['club_main_image'] ?>" alt="Main Image" class="w-32 mb-2">
        <?php endif; ?>
      ...
      <div>
        ...
        <?php if($club['club_extra_image_1']): ?>
          <img src="../uploads/<?= $club['club_extra_image_1'] ?>" alt="Extra Image 1" class="w-32 mb-2">
        <?php endif; ?>
      ...
      <div>
        ...
        <?php if($club['club_extra_image_2']): ?>
          <img src="../uploads/<?= $club['club_extra_image_2'] ?>" alt="Extra Image 2" class="w-32 mb-2">
        <?php endif; ?>
      ...
      <div>
        ...
        <?php if($club['club_extra_image_3']): ?>
          <img src="../uploads/<?= $club['club_extra_image_3'] ?>" alt="Extra Image 3" class="w-32 mb-2">
        <?php endif; ?>

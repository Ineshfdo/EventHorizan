        ...
        <?php foreach($clubs as $club): ?>
          <tr class="border-b hover:bg-gray-50">
            ...
            <td class="p-3 space-x-2">
              ...
              <a href="?delete_id=<?= $club['id'] ?>" class="px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700" onclick="return confirm('Are you sure you want to delete this club?');">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
        <?php if(empty($clubs)) echo '<tr><td colspan="5" class="p-3 text-center">No clubs found</td></tr>'; ?>
      </tbody>
    </table>
  </div>
</main>
